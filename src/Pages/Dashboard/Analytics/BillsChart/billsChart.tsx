...
const BillsChart:React.FC<translationType> = ({t}) => {
    ...
    return ( 
        <article className="bills-chart-wrapper h-full flex flex-col justify-between">
            <div className="flex justify-between items-center mb-3">
                <Tooltip
                    title='مقياس الفواتير والتقارير' 
                    // sx={{fontSize:'20px'}}
                >
                    <h1 className="text-mainDark font-semibold text-lg">{t('home.chart.analytic')}</h1>
                </Tooltip>

                <div className="text-mainDark">
                    <FormControl sx={{ minWidth: 120 }} size="small">
                        <InputLabel id="select-date-range">{t('common.range')}</InputLabel>
                        <Select
