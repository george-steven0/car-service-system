...
import { addCar, getAllCars } from "../../../Components/Redux/Slices/Cars/carSlice";
...
const AddCarModal = ({open,close,t,lang}:ModalType) => {
    ...
    const modalSubmitHandler:SubmitHandler<FormData> = (data)=>{
        const page = 1,
            size = 10,
            paginated = 1
        dispatch(addCar(data)).then( (e)=>{
            ...
            >
                <Box
                    ...
                    <div className="w-full flex justify-between items-start">
                        <h2 className="text-xl text-mainBlue capitalize font-semibold">{t('cars.add')}</h2>

                        <div className="mb-4">
                            <Button className="text-red-600 text-xl text-center cursor-pointer" onClick={close}><FaRegTimesCircle /></Button>
                        </div>
                    </div>
