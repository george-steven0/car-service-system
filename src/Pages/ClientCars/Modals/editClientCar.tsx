...
const EditClientCarModal = ({open,close}:ModalType) => {
    const form = useForm()
            ...
            >
                <Box
                    ...
                    <div className="w-full flex justify-between items-start">
                        <h2 className="text-xl text-mainBlue capitalize font-semibold">تعديل سيارة عميل</h2>
...
export default EditClientCarModal;